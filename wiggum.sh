for i in {0..20}; do
  codex exec -m gpt-5.1-codex-mini --config model_reasoning_effort="medium" --yolo "Using RESP3_PLAN.md, AGENTS.md, TODO.md (if existing), and redis-benchmark, implement and test a complete working Redis server clone called 'ralphdb'."
