...
Evaluation: Yes. `scripts/benchmark_profile.sh` now validates `REQUESTS`, `REPEATS`, `MIXES`, and `BENCH_TIMEOUT_SECONDS`, but the default profile still needs a full rerun and published baseline/candidate deltas.
